...
app = FastAPI(
    title="Open Manus TN - General AI Agent",
    description="A general AI agent that can fulfill user's tasks like generating PDFs, searching the web, summarizing data, or writing detailed charts and reports. It uses a ReAct agent and a collection of tools such as planning, search, PDF, LaTeX, LinkedIn, web browser, etc.",
    version="0.1.0",  
)
